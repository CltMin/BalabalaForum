            ...
            <div class="AppHeader-inner">
                ...
                <div class="gn_nav">
                    <ul class="gn_nav_list">
                        <li>
                            <a href="${pageContext.request.contextPath}/index.jsp" class="AppHeader-navItem1 is-active">
                                <em class="shouyeziti">首页</em>
                            </a>
                        </li>
                        <li><a href="${pageContext.request.contextPath}/topic.jsp" class="AppHeader-navItem is-active">
                            <em>话题</em>
                        </a>
                        </li>
    ...
    <div class="tail">
        ...
        <div class="userInfo">
            ...
            <div class="detailInfo">
                <form class="am-form am-form-horizontal" action="${pageContext.request.contextPath}/updateUserInfoServlet">

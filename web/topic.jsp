...
<div class="topicLead" >
    <div class="navigation-bar-child">
        ...
        <%--搜索--%>
        <form action="${pageContext.request.contextPath}/topicServlet" class="navigation-bar-child-context navigation-bar-child-search">
...
<div class="take-page">
    <div class="pagination"><a id="prev" href="${pageContext.request.contextPath}/topicServlet?method=${topicmethod}&page=prev">上一页</a></div>
    <div class="pagination"><a id="next" href="${pageContext.request.contextPath}/topicServlet?method=${topicmethod}&page=next">下一页</a></div>
</div>
...
<div class="page-type page">
    ...
    <div class="main">
        ...
        <div class="topicTest" >
            <ul class="ulTest" id="liDiv">
                <li class="liTest">
                    <a href="${pageContext.request.contextPath}/topicServlet?method=init">全部类</a>
                </li>
                <li class="liTest">
                    <a href="${pageContext.request.contextPath}/topicServlet?method=codeClass&type=编程类&page=home">编程类</a>
                </li>
                <li class="liTest">
                    <a href="${pageContext.request.contextPath}/topicServlet?method=codeClass&type=学习类&page=home">学习类</a>
                </li>
                <li class="liTest">
                    <a href="${pageContext.request.contextPath}/topicServlet?method=codeClass&type=生活类&page=home">生活类</a>
                </li>
                <li class="liTest">
                    <a href="${pageContext.request.contextPath}/topicServlet?method=codeClass&type=游戏类&page=home">游戏类</a>
                </li>
                <li class="liTest">
                    <a href="${pageContext.request.contextPath}/topicServlet?method=codeClass&type=事业类&page=home">事业类</a>
                </li>
            </ul>
        </div>
        ...
        <div class="explore-tab">
            <ul class="tab-navs">
                &nbsp;  &nbsp; &nbsp;
                <li class="tab-nav" id="giveType"><a href="${pageContext.request.contextPath}/topicServlet?method=moreHotTopic&page=home" class="anchor">热门话题</a></li>
            </ul>
            <!-- 主要大板块 -->
            <div class="tab-panel">
                <div class="daily">
                            ...
                            <div>
                                ...
                                <div class="feed-main-complete">
                                    <div class="author-info">
                                        <span class="author-link-line"><a href="${pageContext.request.contextPath}/userDynamicsServlet?method=lookUserInfo&lookUserId=${topic.replayUserId}" class="underline">${topic.user_Name}</a></span>&nbsp;&nbsp;
                                        <span class="bio"><a href="${pageContext.request.contextPath}/topicServlet?method=codeClass&type=${topic.problemType}">${topic.problemType}</a></span>
                                    </div>
    ...
    <div class="side-bar" style="position: fixed;margin-left: 780px;margin-top: 30px;">
        ...
        <div>
            <ul class="side-nav" >
                <li><a href="${pageContext.request.contextPath}/disorderlyServlet?method=zhinan">·OQ&AF用户指南·</a></li>
                <li><a href="${pageContext.request.contextPath}/disorderlyServlet?method=xieyi">·OQ&AF协议·</a></li>
                <li><a href="${pageContext.request.contextPath}/disorderlyServlet?method=yingsi">·隐私政策·</a></li>
                <li><a href="${pageContext.request.contextPath}/disorderlyServlet?method=jubao">·侵权举报·</a></li>
                <li><a href="${pageContext.request.contextPath}/disorderlyServlet?method=guanyu">关于我们</a></li>
                <li><a href="${pageContext.request.contextPath}/disorderlyServlet?method=jiaru">·加入我们·</a></li>
                <li><a href="${pageContext.request.contextPath}/disorderlyServlet?method=yijian">·意见反馈·</a></li>

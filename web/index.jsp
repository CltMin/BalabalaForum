  ...
  <script type="text/javascript">
      $(function(){
          ...
          $("#loadMore").click(function () {
              var index = $("#index").val();
              $.get(
                  "${pageContext.request.contextPath}/indexServlet?method=loadMore",
                  function () {
          ...
          if(ifLogin){
              ...
              $("#user_img_Btn").attr("href","${pageContext.request.contextPath}/userDynamicsServlet?method=init&Interviewed=${userInfo.user_Id}");
          ...
          $("#publishArticle").click(function () {
              if(ifLogin){
                  alert("即将跳转到写文章页面");
                  window.location.href="${pageContext.request.contextPath}/editor.jsp";
              }else{
          ...
          $(".btn-shoucang").each(function() {
              $(this).bind('click',function(){
                  ...
                  if(ifLogin){
                      if(flage2){
                          $.get(
                              "${pageContext.request.contextPath}/collectionServlet?method=collectReplay",
                              {"pid":pid,"uid":uid},
                              function () {
                          ...
                          $.get(
                              "${pageContext.request.contextPath}/collectionServlet?method=cancelCollectReplay",
                              {"pid":pid,"uid":uid},
                              function () {
          ...
          $("#loadMore").click(function () {
              ...
              $.get(
                  ...
                  function (data) {
                      window.location.href="${pageContext.request.contextPath}/index1.jsp";
                  }
              );
          ...
          $(".replayProblem").click(function(eee) {
              if (ifLogin) {
                  ...
                  $.get(
                      ...
                      function (data) {
                          if(data){
                              window.location.href="${pageContext.request.contextPath}/replay.jsp";
                          }else {
                              alert("你已经回答过了");
                          }
                      }

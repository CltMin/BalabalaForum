...
<body>
  <div class="banner">
    <div class="pull-center">
      ...
      <div class="caoZuo">
        <button><a href="${pageContext.request.contextPath}/resetUserInf.jsp">修改资料</a></button>
        <br>
    ...
    <div class="main">
      ...
      <div class="tab-content">
        ...
        <div class="tab-item huiDa">
          ...
          <c:forEach items="${listUserResponse}" var="userResponse">
              <div class="contentCssSet">
                <h3>回答了:<b style="color: #259;">${userResponse.title}</b>&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/userDynamicsServlet?method=deleteResponse&problemId=${userResponse.problemId}" class="deleteResponse" style="color: red">删除</a> <span style="float: right;color: #999 ; font-size: 14px">${userResponse.replayDate}</span></h3>
                <div class="contentDetail">
                    ${userResponse.replayContent}
                </div>
                <div class="showAll"><span>显示全文</span></div>
        ...
        <div class="tab-item tiWen">
          <c:forEach items="${listUserQuestion}" var="userQuestion">
            <div class="contentCssSet">
              <h3>提出了:<b style="color: #259;">${userQuestion.title}</b> &nbsp;&nbsp;<a href="${pageContext.request.contextPath}/userDynamicsServlet?method=deleteQusetion&problemId=${userQuestion.problemId}" class="deleteQusetion" style="color: red">删除</a><span style="float: right;color: #999 ; font-size: 14px">${userQuestion.problemDate}</span></h3>
              <div class="contentDetail">
                  ${userQuestion.content}
              </div>
              <div class="showAll"><span>显示全文</span></div>
        ...
        <div class="tab-item wenZhang">
          <c:forEach items="${listUserArticle}" var="userArticle">
            <div class="contentCssSet">
              <h3>发表了:<b style="color: #259;">${userArticle.articleTitle}</b> &nbsp;&nbsp;<a href="${pageContext.request.contextPath}/userDynamicsServlet?method=deleteAriticle&articleId=${userArticle.articleId}" class="deleteArticle" style="color: red">删除</a> <span  style="float: right;color: #999 ; font-size: 14px">${userArticle.articleDate}</span></h3>
              <div class="contentDetail">
                  ${userArticle.articleContent}
              </div>
              <div class="showAll"><span>显示全文</span></div>
        ...
        <div class="tab-item shoucang">
          <c:forEach items="${listUserCollection}" var="collection">
            <div class="contentCssSet">
              <h3>收藏了:<b style="color: #259;">${collection.user_Name}&nbsp;的回答</b>&nbsp;&nbsp;<a style="color: orangered" class="delete" href="${pageContext.request.contextPath}/userDynamicsServlet?method=deleteCollection&problemId=${collection.problemId}&replayUserId=${collection.replayUserId}">删除</a> <span style="float: right;color: #999 ; font-size: 14px">${collection.replayDate}</span></h3>
                <div class="contentDetail">
        ...
        <div class="tab-item dongtai active">
          <c:forEach items="${listIdol}" var="idol">
              <div class="list-link" style="display: block">
               ...
               <button style="margin: 18px 0 19px;float: right" id="cancleUser"> <a href="${pageContext.request.contextPath}/userDynamicsServlet?method=cancleSight&Interviewed=${idol.careUserId}">取消关注</a></button>
              </div>

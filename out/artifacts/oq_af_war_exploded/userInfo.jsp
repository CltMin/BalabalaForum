      ...
      <div class="tab-content">
        <div class="tab-item dongtai active">
          <c:forEach items="${listIdol}" var="idol">
              <div class="list-link" style="display: block">
                <a style="float: left" href="/userDynamicsServlet?method=lookUserInfo&lookUserId=${idol.careUserId}"><b style="color: #259;">${idol.careUsername}</b></a>
        ...
        <div class="tab-item">
          <c:forEach items="${listFans}" var="fans">
              <div class="list-link" style="display: block">
                  <a style="float: left"href="/userDynamicsServlet?method=lookUserInfo&lookUserId=${fans.careUserId}"><b style="color: #259;" id="careUserName">${fans.fansUsername}</b></a>
